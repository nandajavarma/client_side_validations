module ClientSideValidations::ActionView::Helpers
  module FormBuilder
    ...
    def initialize_with_client_side_validations(object_name, object, template, options,  block=nil)
      initialize_without_client_side_validations(object_name, object, template, options, block)
